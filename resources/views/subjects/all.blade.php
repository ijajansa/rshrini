...
<script type="text/javascript">
	...
	function datatable()
	{
		...
		var table = $('#myTable').DataTable({
			...
			"ajax":"{{url('subjects/all')}}?subject="+search,
			"columns":[
			{
				"mData": "id",
			...
			
			{
				...
				"ilter": false,
				"mRender": function (data, type, row) {
					return '<div class="d-flex"><a href="{{url("subjects/edit")}}/'+row.id+'" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a><a href="#" onclick="deleteRecord('+row.id+')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a></div>';
	...
	function changeStatus(id)
	{
	    ...
	    {
	        window.location.href="{{url('subjects/status')}}/"+id;
	    }
	...
	function deleteRecord(id)
	{
	    ...
	    {
	        window.location.href="{{url('subjects/delete')}}/"+id;
	    }
