...
<script type="text/javascript">
	$(document).ready(function(){
		var table = $('#myTable').DataTable({
			...
			
			{
				...
				"ilter": false,
				"mRender": function (data, type, row) {
					return '<div class="d-flex"><a href={{url("users/edit")}}/'+row.id+' class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a><a href="#" onclick="deleteRecord('+row.id+')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a></div>';
    ...
    function changeStatus(id)
	{
	    ...
	    {
	        window.location.href="{{url('users/status')}}/"+id;
	    }
