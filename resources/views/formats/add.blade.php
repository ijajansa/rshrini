	...
	<div class="row">
		<div class="col-xl-12">
			<div class="card">
				...
				<div class="card-body">
					<form id="uploadForm" method="POST" action="{{url('chapters/format/add')}}"  enctype="multipart/form-data">
						@csrf
						<div class="row">
						...
						<div class="float-end">
							<button id="submitBtn" class="btn btn-primary" type="submit">Save Details</button>
						</div>
