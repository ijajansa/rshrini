...
// 			},
			...
			
			{
				...
				"ilter": false,
				"mRender": function (data, type, row) {
					return '<div class="d-flex"><a href="{{url("mcq-questions/view")}}/'+row.id+'" class="btn btn-success shadow btn-xs sharp me-1"><i class="fas fa-eye"></i></a><a href="{{url("mcq-questions/edit")}}/'+row.id+'" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a><a href="#" onclick="deleteRecord('+row.id+')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a></div>';
