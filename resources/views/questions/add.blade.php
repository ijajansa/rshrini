						...
						<div class="row">
							<div class="col-xl-12 col-sm-12">
								<div class="mb-3">
									...
									<select class="form-control @error('chapter_id') is-invalid @enderror" name="chapter_id">
										...
										<option value="{{$chapter->id}}" @if(old('chapter_id')==$chapter->id) selected @endif>{{$chapter->name}} - {{$chapter->subject_name}} - {{$chapter->standard_name}}</option>
										@endforeach
									</select>
									@error('chapter_id')
							    ...
							    <div class="mb-3">
									...
									<div class="d-flex align-items-center">
										<div class="form-check">
											<input class="form-check-input" type="radio" name="question_type" value="0" checked @if(old('question_type')=='0') checked @endif id="flexCheckDefault671">
											<label class="form-check-label font-w500" for="flexCheckDefault671">
												Text
											</label>
										</div>
										<div class="form-check ms-3">
											<input class="form-check-input" type="radio" name="question_type" value="1" @if(old('question_type')=='1') checked @endif id="flexCheckDefault781">
							...
							<div class="col-xl-8 col-sm-8">
								...
								<div class="mb-3">
                                    ...
                                    <textarea class="summernote" name="question_text"></textarea>
									@error('question_text')
									<span class="invalid-feedback" role="alert">
										<strong>{{ $message }}</strong>
									</span>
							...
							<div class="col-xl-8 col-sm-8">
								...
								<div class="mb-3">
                                    ...
                                    <textarea class="summernote" name="option1" class="@error('option1') is-invalid @enderror">Option 1</textarea>
									@error('option1')
									<span class="invalid-feedback" role="alert">
										<strong>{{ $message }}</strong>
									</span>
								...
								<div class="mb-3">
									...
									<div class="avatar-upload">
										...
										<div class="change-btn mt-2 mb-lg-0 mb-3">
											<input type="file" class="form-control @error('option1_image') is-invalid @enderror d-none" id="imageUpload1" name="option1_image" onchange="showImagePreview1(event)" accept=".png, .jpg, .jpeg">
							...
							<div class="col-xl-8 col-sm-8">
								...
								<div class="mb-3">
                                    ...
                                    <textarea class="summernote" name="option2" class="@error('option2') is-invalid @enderror">Option 2</textarea>
									@error('option2')
									<span class="invalid-feedback" role="alert">
										<strong>{{ $message }}</strong>
									</span>
								...
								<div class="mb-3">
									...
									<div class="avatar-upload">
										...
										<div class="change-btn mt-2 mb-lg-0 mb-3">
											<input type="file" class="form-control @error('option2_image') is-invalid @enderror d-none" id="imageUpload2" name="option2_image" onchange="showImagePreview2(event)" accept=".png, .jpg, .jpeg">
							...
							<div class="col-xl-8 col-sm-8">
								...
								<div class="mb-3">
                                    ...
                                    <textarea class="summernote" name="option3" class="@error('option3') is-invalid @enderror">Option 3</textarea>
									@error('option3')
									<span class="invalid-feedback" role="alert">
										<strong>{{ $message }}</strong>
									</span>
							...
							<div class="col-xl-8 col-sm-8">
								...
								<div class="mb-3">
                                    ...
                                    <textarea class="summernote" name="option4" class="@error('option4') is-invalid @enderror">Option 4</textarea>
									@error('option4')
									<span class="invalid-feedback" role="alert">
										<strong>{{ $message }}</strong>
									</span>
							...
							<div class="col-xl-8 col-sm-8">
								<div class="mb-3">
									...
									<div class="d-flex align-items-center">
										<div class="form-check">
											<input class="form-check-input" type="radio" name="solution_type" value="0" checked @if(old('solution_type')=='0') checked @endif id="flexCheckDefault67">
											<label class="form-check-label font-w500" for="flexCheckDefault67">
												Text
											</label>
										</div>
										<div class="form-check ms-3">
											<input class="form-check-input" type="radio" name="solution_type" value="1" @if(old('solution_type')=='1') checked @endif id="flexCheckDefault78">
								...
								<div class="mb-3">
                                    ...
                                    <textarea class="summernote" name="solution_text" class="@error('solution_text') is-invalid @enderror">Enter Solution Text</textarea>
									@error('solution_text')
									<span class="invalid-feedback" role="alert">
										<strong>{{ $message }}</strong>
									</span>
